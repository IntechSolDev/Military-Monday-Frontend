      ...
      headerRight: () => (
        <View>
          <View style={{ flexDirection: 'row', paddingRight: 10 }}>
            <Info name={"infocirlceo"} onPress={() => navigation.navigate("AboutUs")} color={"black"} size={20} style={{ marginRight: 10 }} />
            <LogOut name={"logout"}
      ...
      <View style={styles.container}>
        <View style={styles.subcontainer}>
          ...
          <View style={{
            ...
            <Text onPress={() => navigation.navigate("EditProfile")} style={[styles.giftTxt, { color: Styles.PrimaryColor }]}>Edit</Text>
          </View>
          <View style={{ padding: 12 }}>
            ...
            <Input placeholder={user.userdata.business_type ? user.userdata.business_type : "No"} placeholderTextColor={'black'} editible={false} />
          </View>
        </View>
